python CLImessageClient.py aL es
python CLImessageClient.py aL en
python CLImessageClient.py aL fr
python CLImessageClient.py aM "New projection"
python CLImessageClient.py aM "Success!"
python CLImessageClient.py aM "Deleted"
python CLImessageClient.py aM "Proyect name"
python CLImessageClient.py aM "Type a name for your proyect"
python CLImessageClient.py aM "Country"
python CLImessageClient.py aM "Timesone"
